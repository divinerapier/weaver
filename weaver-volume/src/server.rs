...
#[tonic::async_trait]
impl weaver_proto::store::server::Store for StoreService {
    async fn write_needle(
        &self,
        request: tonic::Request<tonic::Streaming<weaver_proto::store::WriteNeedleRequest>>,
    ) -> Result<tonic::Response<weaver_proto::store::WriteNeedleResponse>, tonic::Status> {
        Err(tonic::Status::unimplemented("Not yet implemented"))
    }

    type ReadNeedleStream = mpsc::Receiver<Result<weaver_proto::store::ReadNeedleResponse, Status>>;

    async fn read_needle(
        &self,
        request: tonic::Request<weaver_proto::store::ReadNeedleRequest>,
